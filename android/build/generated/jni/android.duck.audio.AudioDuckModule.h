...
class AudioDuckModule : public titanium::Proxy
{
public:
	explicit AudioDuckModule(jobject javaObject);
...
private:
	// Methods -----------------------------------------------------------
	static v8::Handle<v8::Value> stopSound(const v8::Arguments&);
	static v8::Handle<v8::Value> playSound(const v8::Arguments&);
